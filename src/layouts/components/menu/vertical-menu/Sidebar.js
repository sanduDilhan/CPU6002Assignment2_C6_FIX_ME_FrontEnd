            ...
            <React.Fragment>
              ...
              <div
                className={classnames(
                  `sidebar-wrapper main-menu menu-fixed menu-light menu-accordion menu-shadow theme-${activeTheme}`,
                  {
                    collapsed: sidebarState === true,
                    "hide-sidebar": visibilityState === false
                  }
                )}
                ...
                <ScrollbarTag
                  className={classnames("main-menu-content", {
                    ...
                    "overflow-auto": ScrollbarTag === "div"
                  })}
                  {...(ScrollbarTag !== "div" && {
                  ...
                  <Hammer
                    ...
                    <ul className="navigation navigation-main">
                      <SideMenuContent
                        ...
                        currentUser={Cookies.get(constant.ACCESS_TOKEN) !== undefined || Cookies.get(constant.ACCESS_TOKEN) !== null ? "admin":null}
